...
class CafeApp(tk.Tk):
    ...
    def login_screen(self):
        ...
        self.username_label = tk.Label(self.login_frame, text="Введите имя пользователя:", font=("Verdana", 12), fg="blue")
        self.username_label.pack()
        self.username_entry = tk.Entry(self.login_frame, font=("Verdana", 12))
        self.username_entry.pack()

        self.password_label = tk.Label(self.login_frame, text="Пароль:", font=("Verdana", 12), fg="blue")
        self.password_label.pack()
        self.password_entry = tk.Entry(self.login_frame, show="*", font=("Verdana", 12))
        self.password_entry.pack()

        self.login_button = tk.Button(self.login_frame, text="Войти", command=self.login, bg="lightblue", fg="gray", font=("Arial Bold", 14))
    ...
    def login(self):
        ...
        if username == "admin" and password == "admin":
            ...
            self.waiter_screen()
        elif username == "cook" and password == "cook":
            self.cook_screen()
        else:
    ...
    def waiter_screen(self):
        ...
        self.waiter_window.geometry("700x500")
        self.waiter_window.configure(bg="lightpink")

        self.new_order_button = tk.Button(self.waiter_window, text="Создать новый заказ",
                                          command=self.create_new_order_window, bg="lightblue", fg="black",
                                          font=("Verdana", 12), width=20, height=3)
    ...
    def create_new_order_window(self):
        ...
        self.new_order_window.geometry("700x500")
        self.new_order_window.configure(bg="lightpink")

        self.table_label = tk.Label(self.new_order_window, text="Номер стола:", bg="lightpink", font=("Verdana", 14),
                                    fg="blue")
        self.table_label.pack()
        self.table_entry = tk.Entry(self.new_order_window, font=("Verdana", 12), fg="blue")
        self.table_entry.pack()

        self.customers_label = tk.Label(self.new_order_window, text="Количество клиентов:", bg="lightpink",
                                        font=("Verdana", 14), fg="blue")
        self.customers_label.pack()
        self.customers_entry = tk.Entry(self.new_order_window, font=("Verdana", 12), fg="blue")
        self.customers_entry.pack()

        self.dishes_label = tk.Label(self.new_order_window, text="Выберите блюда:", bg="lightpink",
                                     font=("Verdana", 14), fg="blue")
        ...
        confirm_button = tk.Button(self.new_order_window, text="Подтвердить заказ", command=self.confirm_order,
                                   bg="lightblue", fg="black", font=("Verdana", 12))
        confirm_button.pack()
    ...
    def cook_screen(self):
        ...
        self.cook_window.configure(bg="lightpink")  # Устанавливаем фоновый цвет

        self.view_orders_button = tk.Button(self.cook_window, text="Просмотреть заказы", command=self.view_orders,
                                            width=20, font=("Verdana", 12), bg="lightblue", fg="black")
    ...
    def change_order_status(self):
        ...
        change_status_window.configure(bg="lightpink")  # Устанавливаем фоновый цвет

        order_id_label = tk.Label(change_status_window, text="ID заказа:", font=("Verdana", 12), bg="lightpink")
        order_id_label.pack()

        order_id_entry = tk.Entry(change_status_window, font=("Verdana", 12))
        order_id_entry.pack()

        status_label = tk.Label(change_status_window, text="Новый статус (принят/готов):", font=("Verdana", 12),
                                bg="lightblue")
        status_label.pack()

        status_entry = tk.Entry(change_status_window, font=("Verdana", 12))
        status_entry.pack()
    ...
    def admin_screen(self):
        ...
        self.admin_window.configure(bg="lightpink")  # Задаем светло-розовый фон
        ...
        self.add_user_button = tk.Button(self.admin_window, text="Добавить пользователя", command=self.add_user_entry,
                                         **button_style)
        ...
        self.assign_shift_button = tk.Button(self.admin_window, text="Назначить смену", command=self.assign_shift,
                                             **button_style)
        self.assign_shift_button.pack(pady=10)

        self.work_mode_button = tk.Button(self.admin_window, text="Сведения о работниках", command=self.work_mode,
                                          **button_style)
    ...
    def add_user(self):
        ...
        if not user_exists:
            ...
            messagebox.showinfo("Успешно", f"Пользователь {username} успешно добавлен.")
    ...
    def view_order(self):
        ...
        orders_display = tk.Text(self.admin_window, height=15, width=50)
